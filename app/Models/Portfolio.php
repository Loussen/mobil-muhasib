...
//     protected $fillable = ['slug','name','image','inner_image','work_date'];
    // protected $hidden = [];
    public $translatable = ['name', 'description','content','extras'];
    ...
    */
    public function setImageAttribute($value): void
    {
        ...
        $destination_path = "uploads/images/portfolio";
        ...
        if (Str::startsWith($value, 'data:image'))
        {
            ...
            $image->resize(520, 700, function ($constraint) {
    ...
    public function setInnerImageAttribute($value): void
    {
        ...
        $disk = 'public';
        // destination path relative to the disk above
        $destination_path = "uploads/images/portfolio/inner";

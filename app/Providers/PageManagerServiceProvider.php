...
class PageManagerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // public config
        $this->publishes([__DIR__.'/config/backpack/pagemanager.php' => config_path('backpack/pagemanager.php')]);
        // public languages
        $this->publishes([__DIR__.'/resources/lang' => resource_path('lang/vendor/backpack')], 'lang');

//        $this->mergeConfigFrom(__DIR__.'/config/backpack/pagemanager.php', 'backpack.pagemanager');

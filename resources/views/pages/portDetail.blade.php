                ...
                <div class="col-xxl-8 col-xl-10 offset-xxl-2 offset-xl-1">
                    <div class="blog__detail-top">
                        <h2 class="blog__detail-date animation__word_come">
                            <span>{{ Carbon::parse($portfolio->work_date)->locale(App::getLocale())->isoFormat('DD MMM YYYY') }}</span>
                        </h2>
                        <h3 class="blog__detail-title animation__word_come">{{ $portfolio->getTranslation('name',App::getLocale()) }}</h3>
...
{{--                        <img src="{{ my_asset($portfolio->inner_image) }}" alt="{{ $portfolio->getTranslation('name',App::getLocale()) }}" data-speed="0.5">--}}
{{--                    </div>--}}
{{--                </div>--}}
                <div class="col-xxl-8 col-xl-10 offset-xxl-2 offset-xl-1">
                    <div class="blog__detail-content">
                        {!! $portfolio->getTranslation('content',App::getLocale()) !!}
                    </div>
